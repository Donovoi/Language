.PHONY: bootstrap gateway-venv generate-contract-bindings contract-bindings-check research-pack research-pack-check audio-corpus-catalog-check smoke-local-demo smoke-integration-demo check test-category test-quick test-contracts test-audio-fixtures test-all release-audio-gate live-microphone-capture-list-devices live-microphone-capture-check real-room-playback-suppression-list-devices real-room-playback-suppression-contract-check headphone-isolation-contract-check headphone-isolation-list-devices headphone-isolation-preflight headphone-isolation-probe-route headphone-isolation-sweep-routes headphone-isolation-virtual-lab headphone-isolation-prepare-manual headphone-isolation-collect-evidence headphone-isolation-check-manual headphone-isolation-play-manual headphone-isolation-import-manual headphone-isolation-score-manual headphone-isolation-capture headphone-isolation-score real-room-playback-suppression-probe-route real-room-playback-suppression-sweep-routes real-room-playback-suppression-qualify-device real-room-playback-suppression-sweep-devices real-room-playback-suppression-check rust-check python-check flutter-check dev-env-build dev-env-check dev-env-shell dev-env-destroy dev-env-purge audio-eval-build audio-eval-check audio-eval-real-speech-check audio-eval-real-speech-chunked-check audio-eval-crowd-noise-check audio-eval-translation-check audio-eval-live-capture-contract-check audio-eval-live-capture-check audio-eval-playback-suppression-contract-check audio-eval-playback-suppression-check audio-eval-fallback-tts-contract-check audio-eval-fallback-tts-check audio-eval-same-voice-candidate-contract-check audio-eval-oracle-tse-contract-check audio-eval-oracle-tse-check audio-eval-mixture-passthrough-tse-contract-check audio-eval-mixture-passthrough-tse-check audio-eval-enrolled-tse-contract-check audio-eval-enrolled-oracle-tse-check audio-eval-enrolled-mismatch-tse-check audio-eval-shell audio-eval-purge audio-eval-pyannote-build audio-eval-pyannote-check audio-eval-pyannote-real-speech-check audio-eval-pyannote-real-speech-chunked-check audio-eval-pyannote-shell audio-eval-pyannote-purge audio-eval-sortformer-build audio-eval-sortformer-contract-check audio-eval-sortformer-real-speech-check audio-eval-sortformer-real-speech-chunked-check audio-eval-sortformer-online-real-speech-check audio-eval-sortformer-rolling-real-speech-check audio-eval-sortformer-rolling-fleurs-check audio-eval-sortformer-shell audio-eval-sortformer-purge audio-eval-whisper-build audio-eval-whisper-contract-check audio-eval-whisper-translation-check audio-eval-whisper-rolling-contract-check audio-eval-whisper-rolling-translation-check audio-eval-whisper-oracle-tse-contract-check audio-eval-whisper-oracle-tse-translation-check audio-eval-whisper-mixture-passthrough-tse-contract-check audio-eval-whisper-mixture-passthrough-tse-translation-check audio-eval-whisper-causal-tse-contract-check audio-eval-whisper-speechbrain-sepformer-translation-check audio-eval-whisper-enrolled-oracle-tse-translation-check audio-eval-whisper-wesep-translation-check audio-eval-whisper-wesep-causal-translation-check audio-eval-whisper-shell audio-eval-whisper-purge audio-eval-speechbrain-sepformer-build audio-eval-speechbrain-sepformer-contract-check audio-eval-speechbrain-sepformer-check audio-eval-speechbrain-voice-similarity-contract-check audio-eval-speechbrain-voice-similarity-check audio-eval-speechbrain-sepformer-shell audio-eval-speechbrain-sepformer-purge audio-eval-wesep-build audio-eval-wesep-contract-check audio-eval-wesep-check audio-eval-wesep-shell audio-eval-wesep-purge gateway-run flutter-run gateway-package flutter-release-android source-bundle

.PHONY: audio-eval-same-voice-candidate-check
...
HEADPHONE_ISOLATION_PROBE_ROUTE_ARGS ?=
HEADPHONE_ISOLATION_SWEEP_ROUTES_ARGS ?=
HEADPHONE_ISOLATION_VIRTUAL_LAB_ARGS ?=
HEADPHONE_ISOLATION_PREPARE_MANUAL_ARGS ?=
HEADPHONE_ISOLATION_COLLECT_EVIDENCE_ARGS ?=
HEADPHONE_ISOLATION_CHECK_MANUAL_ARGS ?=
HEADPHONE_ISOLATION_PLAY_MANUAL_ARGS ?=
HEADPHONE_ISOLATION_IMPORT_MANUAL_ARGS ?=
HEADPHONE_ISOLATION_SCORE_MANUAL_ARGS ?=
HEADPHONE_ISOLATION_SCORE_ARGS ?=
TEST_CATEGORY ?= quick
TEST_CATEGORY_ARGS ?=
...
test-category:
	python3 scripts/run_test_category.py $(TEST_CATEGORY) $(TEST_CATEGORY_ARGS)
...
test-audio-fixtures:
	python3 scripts/run_test_category.py audio-fixtures
...
headphone-isolation-preflight:
	python3 scripts/run_headphone_isolation_check.py preflight $(HEADPHONE_ISOLATION_PREFLIGHT_ARGS)

headphone-isolation-probe-route:
	python3 scripts/run_headphone_isolation_check.py probe-route $(HEADPHONE_ISOLATION_PROBE_ROUTE_ARGS)

headphone-isolation-sweep-routes:
	python3 scripts/run_headphone_isolation_check.py sweep-routes $(HEADPHONE_ISOLATION_SWEEP_ROUTES_ARGS)

headphone-isolation-virtual-lab:
	python3 scripts/run_headphone_isolation_check.py virtual-lab $(HEADPHONE_ISOLATION_VIRTUAL_LAB_ARGS)

headphone-isolation-prepare-manual:
	python3 scripts/run_headphone_isolation_check.py prepare-manual $(HEADPHONE_ISOLATION_PREPARE_MANUAL_ARGS)

headphone-isolation-collect-evidence:
	python3 scripts/run_headphone_isolation_check.py collect-headphone-evidence $(HEADPHONE_ISOLATION_COLLECT_EVIDENCE_ARGS)

headphone-isolation-check-manual:
	python3 scripts/run_headphone_isolation_check.py check-manual $(HEADPHONE_ISOLATION_CHECK_MANUAL_ARGS)

headphone-isolation-play-manual:
	python3 scripts/run_headphone_isolation_check.py play-manual $(HEADPHONE_ISOLATION_PLAY_MANUAL_ARGS)

headphone-isolation-import-manual:
	python3 scripts/run_headphone_isolation_check.py import-manual $(HEADPHONE_ISOLATION_IMPORT_MANUAL_ARGS)

headphone-isolation-score-manual:
	python3 scripts/run_headphone_isolation_check.py score-manual $(HEADPHONE_ISOLATION_SCORE_MANUAL_ARGS)
...
headphone-isolation-score:
	python3 scripts/run_headphone_isolation_check.py score $(HEADPHONE_ISOLATION_SCORE_ARGS)
...
audio-eval-same-voice-candidate-contract-check: audio-eval-build
	AUDIO_EVAL_IMAGE=$(AUDIO_EVAL_IMAGE) $(DOCKER_COMPOSE) -f $(DEV_COMPOSE_FILE) --profile audio-eval run --rm audio-eval python3 scripts/benchmark_same_voice_candidate_fixture.py --self-test

audio-eval-same-voice-candidate-check: audio-eval-build
	AUDIO_EVAL_IMAGE=$(AUDIO_EVAL_IMAGE) $(DOCKER_COMPOSE) -f $(DEV_COMPOSE_FILE) --profile audio-eval run --rm audio-eval python3 scripts/benchmark_same_voice_candidate_fixture.py check $(SAME_VOICE_CANDIDATE_ARGS)
...
audio-eval-speechbrain-voice-similarity-contract-check: audio-eval-build
	AUDIO_EVAL_IMAGE=$(AUDIO_EVAL_IMAGE) $(DOCKER_COMPOSE) -f $(DEV_COMPOSE_FILE) --profile audio-eval run --rm audio-eval python3 scripts/run_speechbrain_voice_similarity_fixture.py --self-test

audio-eval-speechbrain-voice-similarity-check: audio-eval-speechbrain-sepformer-build
	AUDIO_EVAL_SPEECHBRAIN_SEPFORMER_IMAGE=$(AUDIO_EVAL_SPEECHBRAIN_SEPFORMER_IMAGE) $(DOCKER_COMPOSE) -f $(DEV_COMPOSE_FILE) --profile audio-eval-speechbrain-sepformer run --rm audio-eval-speechbrain-sepformer python3 scripts/run_speechbrain_voice_similarity_fixture.py score $(SPEECHBRAIN_VOICE_SIMILARITY_ARGS)
