...
def write_manual_recording_checklist(
    *,
    ...
    lines = [
        ...
        "",
        "Minimal setup for the current laptop/headset path:",
        "",
        "- Source output: laptop speakers or another non-headphone speaker.",
        "- Translated output: the Bluetooth headset/headphones being tested.",
        "- Measurement input: phone recorder, USB mic, lavalier mic, or field recorder placed at the ear position.",
        "- Not enough for release: laptop built-in mic alone, or the headset microphone away from the earcup.",
        "",
        "## Kit Settings",
        "",
    ...
    lines.extend(
        [
            ...
            "```",
            "",
            "If recorder files have different names, stage them into the dropbox first:",
            "",
            "```powershell",
            ...
            "```",
            "",
            "Use `python scripts/release_audio_status.py --full-commands` only when you need lower-level playback commands.",
            "",
            "Equivalent low-level dry run:",
            "",
            "```powershell",
...
def write_manual_raw_recording_dropbox(
    *,
    ...
    lines = [
        ...
        "- Minimal release setup: laptop/non-headphone speaker for the source, headset/headphones for translated output, and a separate phone/USB/lav recorder at the ear position.",
        "",
        "## Expected Paths",
        "",
    ]
    ...
    lines.extend(
        [
            ...
            "",
            "If your recorder exports different WAV filenames, set `LANGUAGE_SOURCE_OPEN_EAR_RECORDING`, `LANGUAGE_SOURCE_ISOLATED_EAR_RECORDING`, and `LANGUAGE_TRANSLATED_HEADPHONE_RECORDING`, then run `python scripts/run_test_category.py stage-recordings`.",
