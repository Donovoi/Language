...
from app.models import LaneStatus, SessionMode, SourceSuppressionMode, SpeakerState
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    input_level_dbfs=-22.0,
                    output_level_dbfs=-22.0,
                    ...
                    original_voice_suppression_db=5.0,
                    playback_latency_ms=260,
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    output_level_dbfs=-22.0,
                    translated_audio_stream_id="mix-demo-alice-opening-en",
        ...
        _SpeakerFrameStep(
            mutations=(
                ...
                _speaker_mutation(
                    ...
                    lane_status=LaneStatus.LISTENING,
                    status_message=listening,
                    input_level_dbfs=-15.0,
                    output_level_dbfs=-15.0,
                    overlapping_speaker_ids=[],
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    status_message=ready,
                    output_level_dbfs=-15.0,
                    translated_audio_stream_id="mix-demo-bruno-update-en",
        ...
        _SpeakerFrameStep(
            mutations=(
                ...
                _speaker_mutation(
                    ...
                    lane_status=LaneStatus.LISTENING,
                    status_message=listening,
                    input_level_dbfs=-18.0,
                    output_level_dbfs=-18.0,
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    status_message=ready,
                    output_level_dbfs=-18.0,
                    translated_audio_stream_id="mix-demo-carmen-north-exit-en",
                    original_voice_suppression_db=6.0,
                    playback_latency_ms=350,
                    source_suppression_mode=SourceSuppressionMode.OVERLAY_DUCKING,
                ),
            )
        ),
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    status_message=ready,
                    output_level_dbfs=-24.0,
                    translated_audio_stream_id="mix-demo-alice-reroute-en",
                    original_voice_suppression_db=6.0,
                    playback_latency_ms=275,
                    source_suppression_mode=SourceSuppressionMode.OVERLAY_DUCKING,
                ),
            )
        ),
        ...
        _SpeakerFrameStep(
            mutations=(
                ...
                _speaker_mutation(
                    ...
                    lane_status=LaneStatus.LISTENING,
                    status_message=listening,
                    input_level_dbfs=-13.0,
                    output_level_dbfs=-13.0,
                    overlapping_speaker_ids=["speaker-carmen"],
                    detected_language_code="pt-BR",
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    status_message=ready,
                    output_level_dbfs=-13.0,
                    translated_audio_stream_id="mix-demo-bruno-buses-en",
                    original_voice_suppression_db=7.0,
                    playback_latency_ms=325,
                    source_suppression_mode=SourceSuppressionMode.OVERLAY_DUCKING,
                ),
            )
        ),
        _SpeakerFrameStep(
            mutations=(
                ...
                _speaker_mutation(
                    ...
                    lane_status=LaneStatus.LISTENING,
                    status_message=listening,
                    input_level_dbfs=-17.0,
                    output_level_dbfs=-17.0,
                    overlapping_speaker_ids=["speaker-bruno"],
                    detected_language_code="es",
        ...
        _SpeakerFrameStep(
            mutations=(
                _speaker_mutation(
                    ...
                    status_message=ready,
                    output_level_dbfs=-17.0,
                    translated_audio_stream_id="mix-demo-carmen-route-open-en",
                    original_voice_suppression_db=7.0,
                    playback_latency_ms=350,
                    source_suppression_mode=SourceSuppressionMode.OVERLAY_DUCKING,
                ),
