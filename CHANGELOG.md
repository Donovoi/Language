...
- The hard release audio gate now writes a Markdown operator handoff beside the JSON report so release blockers and next hardware actions are readable without weakening the machine-checked gate.
