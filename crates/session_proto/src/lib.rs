...
impl From<&SpeakerState> for language::session::v1::SpeakerState {
    fn from(value: &SpeakerState) -> Self {
        Self {
            ...
            input_level_dbfs: 0.0,
            output_level_dbfs: 0.0,
            overlapping_speaker_ids: Vec::new(),
            detected_language_code: String::new(),
            language_confidence: 0.0,
            voice_clone_id: String::new(),
            voice_clone_status: String::new(),
            translated_audio_stream_id: String::new(),
            original_voice_suppression_db: 0.0,
            playback_latency_ms: 0,
            source_suppression_mode: language::session::v1::SourceSuppressionMode::Unspecified
                as i32,
        }
    }
}
...
mod tests {
    ...
    fn converts_proto_speaker_into_audio_core() {
        let speaker = SpeakerState::try_from(v1::SpeakerState {
            ...
            overlapping_speaker_ids: Vec::new(),
            detected_language_code: String::from("en-us"),
            language_confidence: 0.99,
            voice_clone_id: String::from("voice-speaker-1"),
            voice_clone_status: String::from("READY"),
            translated_audio_stream_id: String::from("mix-speaker-1-en"),
            original_voice_suppression_db: 18.0,
            playback_latency_ms: 280,
            source_suppression_mode: v1::SourceSuppressionMode::OverlayDucking as i32,
        })
        ...
        let ranked = rank_proto_session(&v1::SessionState {
            ...
            speakers: vec![
                v1::SpeakerState {
                    ...
                    original_voice_suppression_db: 0.0,
                    playback_latency_ms: 0,
                    source_suppression_mode: v1::SourceSuppressionMode::Unspecified as i32,
                },
                v1::SpeakerState {
